...
const SettingsPage = () => {
  ...
  const handleProfileSave = async () => {
    ...
    try {
      ...
      if (user && token) {
        setAuth(token, { ...user, fullName: displayName });
      }
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-white border border-gray-200/60 rounded-2xl p-8 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-surface-2 border border-gray-200 rounded-xl px-4 py-3 text-foreground text-base outline-none focus:border-blue-electric focus:ring-2 focus:ring-blue-electric/10 transition-all"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          disabled
                          className="w-full bg-surface-2 border border-gray-200 rounded-xl px-4 py-3 text-foreground text-base outline-none opacity-60 cursor-not-allowed"
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mt-6 pt-6 border-t border-gray-100">
                      ...
                      <button
                        onClick={() => setDisplayName(user?.fullName || "")}
                        className="text-white-60 hover:text-foreground px-6 py-3 rounded-xl font-medium text-sm transition-colors"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <div className="bg-white border border-gray-200/60 rounded-2xl p-8 shadow-sm">
                    ...
                    <textarea
                      rows={4}
                      defaultValue="Senior Software Engineer with 6+ years building scalable distributed systems. Expert in React, Node.js, and cloud infrastructure."
                  ...
                  <div className="bg-white border border-gray-200/60 rounded-2xl p-8 shadow-sm">
                    ...
                    <div className="space-y-4 max-w-md">
                      <div>
                        ...
                        <input type="password" placeholder="••••••••" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} className="w-full bg-surface-2 border border-gray-200 rounded-xl px-4 py-3 text-foreground text-base outline-none focus:border-blue-electric focus:ring-2 focus:ring-blue-electric/10 transition-all" />
                      </div>
                      <div>
                        <label className="text-foreground text-sm font-medium mb-2 block">New Password</label>
                        <input type="password" placeholder="••••••••" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full bg-surface-2 border border-gray-200 rounded-xl px-4 py-3 text-foreground text-base outline-none focus:border-blue-electric focus:ring-2 focus:ring-blue-electric/10 transition-all" />
                      </div>
                      <div>
                        <label className="text-foreground text-sm font-medium mb-2 block">Confirm New Password</label>
                        <input type="password" placeholder="••••••••" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="w-full bg-surface-2 border border-gray-200 rounded-xl px-4 py-3 text-foreground text-base outline-none focus:border-blue-electric focus:ring-2 focus:ring-blue-electric/10 transition-all" />
                      </div>
                      <button
